...
require_relative 'lib/k_quick/version'

Gem::Specification.new do |spec|
  spec.name          = 'k_quick'
  spec.version       = KQuick::VERSION
  spec.authors       = ['David']
  spec.email         = ['david@ideasmen.com.au']

  spec.summary       = 'K Quick is a command line tool to quickly access each of my projects'
  spec.description   = 'K Quick is a command line tool to quickly access each of my projects'
  spec.homepage      = 'http://appydave.com/tool/k_quick'
  spec.license       = 'MIT'
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/klueless-io/k_quick'
  spec.metadata['changelog_uri'] = 'https://github.com/klueless-io/k_quick/commits/master'
  ...
  spec.extensions    = ['ext/k_quick/extconf.rb']
